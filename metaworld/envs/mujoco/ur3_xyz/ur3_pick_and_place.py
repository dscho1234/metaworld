...
from metaworld.envs.mujoco.ur3_xyz.ur3_base import UR3XYZEnv
...
class UR3PickAndPlaceEnv(UR3XYZEnv):
    def __init__(
            self,
            obj_low=None,
            obj_high=None,
        ...
        # obj_high=(0.5, 1, 0.5)
        hand_low=(-0.3, 0.35, 0.05)
        hand_high=(0.3, 0.65, 0.3)
        obj_low=(-0.3, 0.35, 0.05)
        obj_high=(0.3, 0.65, 0.3)
        UR3XYZEnv.__init__(
            self,
            frame_skip=5,
            action_scale=1./100,
    ...
    @property
    def model_name(self):
        return get_asset_full_path('ur3_xyz/ur3_pick_and_place.xml') 
    ...
    def _set_obj_xyz(self, pos):
        ...
        # qpos[9:12] = pos.copy() #0 ~ 6 sawyer, 7~8 gripper, 9~11 object pos, 12~15 object quat
        # qvel[9:15] = 0 #0~6 sawyer, 7~8 gripper, 9~15 object vel, angvel
